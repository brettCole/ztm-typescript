...
function removeTodo(id: number): void {
    ...
    saveTodos(todos);
    console.log(`Remove todo ${removedTodo.id}: ${removedTodo.task}`);
}
...
function clieInvalidOption(command: string): void {
